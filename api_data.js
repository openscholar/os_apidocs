define({ "api": [
  ...
  },
  {
    ...
    "name": "Patch",
    "group": "Book",
    "description": "<p>Patch a book entry.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "filename": "../OpenScholarMake/openscholar/modules/os/modules/os_restful/plugins/restful/files/1.0/OsFilesResource.class.php",
    "groupTitle": "Files"
  },
  {
    "type": "get",
    ...
    "sampleRequest": [
      {
        "url": "http://localhost/OpenScholarMake/www/api/files/:id"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "name": "Group",
    "group": "Group",
    "description": "<p>OpenScholar uses Organic Groups in order to have content attached to vsite. Actually, each vsite is a group. This give us the options to override site wide settings(roles and permission).</p> <p>There are 3 types of groups: personal, project and department when personal can have sub-sites.</p> ",
    "sampleRequest": [
      {
        "url": "http://localhost/OpenScholarMake/www/api/group"
      }
    ],
    "parameter": {
      "fields": {
  ...
  },
  {
    ...
    "name": "Patch",
    "group": "Layout",
    "description": "<p>Update a layout in a vsite.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "filename": "../OpenScholarMake/openscholar/modules/os/modules/os_restful/plugins/restful/og_vocab/1.0/OsOgVocab.class.php",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost/OpenScholarMake/www/api/og_vocab/:id"
      }
    ]
  },
  {
    ...
    "name": "Patch",
    "group": "Og_Vocabulary",
    "description": "<p>Patch an og vocabulary.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "filename": "../OpenScholarMake/openscholar/modules/os/modules/os_restful/plugins/restful/node/person/1.0/PersonNodeRestfulBase.class.php",
    "groupTitle": "Person"
  },
  {
    "type": "get",
    ...
    "sampleRequest": [
      {
        "url": "http://localhost/OpenScholarMake/www/api/person/:id"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "name": "Delete",
    "group": "Presentation",
    "description": "<p>Create a Presentation entry.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "filename": "../OpenScholarMake/openscholar/modules/os/modules/os_restful/plugins/restful/node/presentation/1.0/PresentationNodeRestfulBase.class.php",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost/OpenScholarMake/www/api/presentation/:id"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "filename": "../OpenScholarMake/openscholar/modules/os/modules/os_restful/plugins/restful/roles/1.0/OsRestfulRoles.class.php",
    "groupTitle": "Roles",
    "sampleRequest": [
      {
        "url": "http://localhost/OpenScholarMake/www/api/roles?vsite=:id"
      }
    ]
  },
  {
    ...
    "filename": "../OpenScholarMake/openscholar/modules/os/modules/os_restful/plugins/restful/node/slideshow_slide/1.0/SlideshowSlideNodeRestfulBase.class.php",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost/OpenScholarMake/www/api/slideshow_slide/:id"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "filename": "../OpenScholarMake/openscholar/modules/os/modules/os_restful/plugins/restful/node/software_project/1.0/SoftwareProjectNodeRestfulBase.class.php",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost/OpenScholarMake/www/api/software_project/:id"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "filename": "../OpenScholarMake/openscholar/modules/os/modules/os_restful/plugins/restful/node/software_release/1.0/SoftwareReleaseNodeRestful.class.php",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost/OpenScholarMake/www/api/software_release/:id"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "filename": "../OpenScholarMake/openscholar/modules/os/modules/os_restful/plugins/restful/taxonomy/1.0/OsTaxonomyTerm.class.php",
    "groupTitle": "Term"
  },
  {
    "type": "get",
    ...
    "sampleRequest": [
      {
        "url": "http://localhost/OpenScholarMake/www/api/taxonomy?vsite=:id"
      }
    ]
  },
  {
    ...
    "name": "Patch",
    "group": "Term",
    "description": "<p>Patch a taxonomy term.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost/OpenScholarMake/www/api/taxonomy"
      }
    ]
  },
  {
    ...
    "filename": "../OpenScholarMake/openscholar/modules/os/modules/os_restful/plugins/restful/user/1.0/OsRestfulUser.class.php",
    "groupTitle": "User",
    "sampleRequest": [
      {
        "url": "http://localhost/OpenScholarMake/www/api/users/:id"
      }
    ]
  },
  {
    ...
    "name": "Patch",
    "group": "User",
    "description": "<p>Patch a user entity.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "filename": "../OpenScholarMake/openscholar/modules/os/modules/os_restful/plugins/restful/vsite_variables/1.0/OsRestfulVariables.class.php",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost/OpenScholarMake/www/api/variables/:id"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "filename": "../OpenScholarMake/openscholar/modules/os/modules/os_restful/plugins/restful/vocabulary/1.0/OsVocabulary.class.php",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost/OpenScholarMake/www/api/vocabulary?vsite=:id"
      }
    ]
  },
  {
    ...
    "name": "Patch",
    "group": "Vocabulary",
    "description": "<p>Patch a vocabulary.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost/OpenScholarMake/www/api/vocabulary"
      }
    ]
  }
] });